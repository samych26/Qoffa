...
class _BakeryPageState extends State<BakeryPage> {
  ...
  void _loadCommercants() {
    _controller.chargerCommercantsParCategorie("bakery").listen((commercants) {
      setState(() {
  ...
  void _onSearchChanged() {
    ...
    setState(() {
      _filteredCommercants = _allCommercants.where((commercant) {
        return commercant.nomCommerce.toLowerCase().startsWith(searchTerm);
      }).toList();
    });
  }

  void _scrollToShop(String nomCommerce) {
    final index = _allCommercants.indexWhere((c) => c.nomCommerce == nomCommerce);
    if (index != -1) {
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                _buildTitleSection('Discover Bakeries'),
  ...
  Widget _buildSearchSection() {
    return Column(
      ...
      children: [
        ...
        if (_searchController.text.isNotEmpty && _filteredCommercants.isNotEmpty)
          Container(
            decoration: BoxDecoration(
              color: Colors.white,
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final suggestion = _filteredCommercants[index];
                return ListTile(
                  title: Text(suggestion.nomCommerce),
                  onTap: () {
                    _scrollToShop(suggestion.nomCommerce);
                    setState(() {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            _buildCategoryIconWithImage(context, 'assets/images/bakeryJaune.png', 'Bakery', isSelected: true),
  ...
  Widget _buildShopsSection(BuildContext context) {
    final List<Commerce> commercantsToShow = _searchController.text.isNotEmpty
      ...
      children: [
        ...
        if (commercantsToShow.isEmpty)
          ...
          ListView.builder(
            ...
            shrinkWrap: true,
            itemCount: commercantsToShow.length,
            itemBuilder: (context, index) {
              final commercant = commercantsToShow[index];
              return Padding(
