...
class _RestaurantPageState extends State<RestaurantPage> {
  ...
  void initState() {
    super.initState();
    _loadRestaurantFavorites();
  }

  Future<void> _loadRestaurantFavorites() async {
    setState(() {
      _isLoading = true;
    });

    try {
      final restaurantFavorites = await _controller.fetchRestaurantFavorites();
      ...
      print('Erreur lors du chargement des favoris restaurant: $e');
      setState(() {
        restaurants = [];
        _isLoading = false;
      });
            ...
            Expanded(
              child:
                  _isLoading
                      ...
                      ? const Center(
                        child: Text(
                          "Aucun favori de type restaurant trouvé",
          ...
          Row(
            ...
            children: [
              ...
              _buildCategoryButton(
                'assets/images/restaurantAnim.png',
                'Restaurant',
                () {},
              ),
