...
class _BakeryPageState extends State<BakeryPage> {
  ...
  void initState() {
    super.initState();
    _loadBakeryFavorites();
  }

  Future<void> _loadBakeryFavorites() async {
    setState(() {
      _isLoading = true;
    });

    try {
      final bakeryFavorites = await _controller.fetchBakeryFavorites();

      if (bakeryFavorites.isEmpty) {
            ...
            Expanded(
              child:
                  _isLoading
                      ...
                      ? const Center(
                        child: Text(
                          "Aucun favori de type bakery trouvé",
